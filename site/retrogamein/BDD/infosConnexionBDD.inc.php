 ...
 */
    ...
    $_ENV["dsn"] = "mysql:host={$_ENV["host"]};dbname={$_ENV["dbname"]};port={$_ENV["port"]}"; // data source name (version utilisant les accolades d'interpolation pour inclure les variables)
